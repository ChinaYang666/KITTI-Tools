...
if(kitti_tools_CONFIG_INCLUDED)
  return()
endif()
set(kitti_tools_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(kitti_tools_SOURCE_PREFIX /home/yang/Code/catkin_ws/src/kitti_tools)
  set(kitti_tools_DEVEL_PREFIX /home/yang/Code/catkin_ws/src/kitti_tools/build/devel)
  set(kitti_tools_INSTALL_PREFIX "")
  set(kitti_tools_PREFIX ${kitti_tools_DEVEL_PREFIX})
else()
  set(kitti_tools_SOURCE_PREFIX "")
  set(kitti_tools_DEVEL_PREFIX "")
  set(kitti_tools_INSTALL_PREFIX /usr/local)
  set(kitti_tools_PREFIX ${kitti_tools_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'kitti_tools' is deprecated")
...
set(kitti_tools_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/yang/Code/catkin_ws/src/kitti_tools/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(kitti_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/yang/Code/catkin_ws/src/kitti_tools/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${kitti_tools_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kitti_tools' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'kitti_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yang/Code/catkin_ws/src/kitti_tools/${idir}'.  ${_report}")
    endif()
    _list_append_unique(kitti_tools_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND kitti_tools_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND kitti_tools_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT kitti_tools_NUM_DUMMY_TARGETS)
      set(kitti_tools_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::kitti_tools::wrapped-linker-option${kitti_tools_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR kitti_tools_NUM_DUMMY_TARGETS "${kitti_tools_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::kitti_tools::wrapped-linker-option${kitti_tools_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND kitti_tools_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yang/Code/catkin_ws/src/kitti_tools/build/devel/lib;/home/yang/Code/catkin_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(kitti_tools_LIBRARY_DIRS ${lib_path})
      list(APPEND kitti_tools_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'kitti_tools'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND kitti_tools_LIBRARIES ${lib})
    endif()
  endif()
...
set(kitti_tools_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${kitti_tools_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 kitti_tools_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${kitti_tools_dep}_FOUND)
      find_package(${kitti_tools_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kitti_tools_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(kitti_tools_INCLUDE_DIRS ${${kitti_tools_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(kitti_tools_LIBRARIES ${kitti_tools_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${kitti_tools_dep}_LIBRARIES})
  _list_append_deduplicate(kitti_tools_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(kitti_tools_LIBRARIES ${kitti_tools_LIBRARIES})

  _list_append_unique(kitti_tools_LIBRARY_DIRS ${${kitti_tools_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(kitti_tools_EXPORTED_TARGETS ${${kitti_tools_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${kitti_tools_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
